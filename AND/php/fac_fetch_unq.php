    ...
    ?>
 <html><title> Attendance By Unique Code
...
<link href="/./AND/ext/select1.css" rel="stylesheet" type="text/css">
<script>
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","get_fac_rec_unq.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
$sql="select DISTINCT(branch),subj.b_id from fac_details,subj,branch where subj.b_id=branch.b_id AND fac_details.fac_id=subj.fac_id AND fac_details.username= '".$login_session."' group by branch";
