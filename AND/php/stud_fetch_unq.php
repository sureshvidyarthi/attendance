...
$sql="select DISTINCT(branch),subj.b_id from fac_details,subj,branch where subj.b_id=branch.b_id AND fac_details.fac_id=subj.fac_id AND fac_details.username= '$login_session'";
